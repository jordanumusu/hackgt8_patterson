    ...
    >
      <div className="md:mt-3 self-start md:self-auto">
        <img
          ...
          className="md:hidden absolute z-10 top-4 left-4 w-5 h-5"
      ...
      <div
        className={
          "bg-white z-20 md:z-0 absolute md:static flex-col items-start justify-center w-full h-full md:mt-4 mx-4 md:rounded-2xl shadow relative" +
          (toggleLinks ? "" : " hidden md:block")
        }
      >
        <div
          className="flex flex-row justify-end mt-5 mr-5 text-gray-400 md:hidden"
        ...
        <nav className="flex flex-col w-full justify-center mt-6">
          ...
          <div className="group flex items-center my-4 ml-6">
            <div className="w-8 h-8 mx-3 text-gray-400">
              <Twitter/> 
              </div>
              </div>
              <div className="group flex items-center my-4 ml-6">
